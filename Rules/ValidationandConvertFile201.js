 ...
 */
export default async function ValidateAndConvertFile201(clientAPI) {
...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        const question = sectionedTable
            .getSection('Section201Form')
            .getControl('Section201Question')
            .getValue();
        ...
        await clientAPI.executeAction({
            Name: "/TRL_RH_SnorkelApp/Actions/AttachmentCreate201.action",
            Properties: {
                Properties: {
                    question: question,
        ...
        // ✅ Show next section
        sectionedTable.getSection('Section202Form').setVisible(true);
