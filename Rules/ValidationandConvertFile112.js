...
export default async function ValidateAndConvertFile112(clientAPI) {
    ...
    try {
        ...
        const question = sectionedTable
            .getSection('Section112Form')
            .getControl('Section112Question')
            .getValue();
        ...
        await clientAPI.executeAction({
            Name: "/TRL_RH_SnorkelApp/Actions/AttachmentCreate112.action",
            Properties: {
                Properties: {
                    question: question,
        ...
        // ✅ Show next section
        sectionedTable.getSection('Section113Form').setVisible(true);
