 ...
 */
export default function Section142Validation(clientAPI) {
    try {
    ...
    const Section142UserInputImage1 =FormSectionedTable.getSection('Section143Form');
    Section142UserInputImage1.setVisible('true');
    FormSectionedTable.getSection('Section142Form').getControl('Section143NextButton').setVisible(false);
            return clientAPI.executeAction({
                Name: '/TRL_RH_SnorkelApp/Actions/Section142Create.action'
            });
