...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        await clientAPI.executeAction({
            Name: "/TRL_RH_SnorkelApp/Actions/AttachmentCreate113.action",
            Properties: {
                Properties: {
                    question: question,
        ...
        // ✅ Show next section
        const section121Form = sectionedTable.getSection('Section121Form');
        if (section121Form) {
            await section121Form.setVisible(true);
        }
