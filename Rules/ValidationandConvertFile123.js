 ...
 */
export default async function ValidateAndConvertFile123(clientAPI) {
...
const binding = pageProxy.getBindingObject();
    ...
    try {
        ...
        const photoSection = sectionedTable.getSection('Section123UserInputImage');
        const photoControl = photoSection?.getControl('Section123TakePhoto');
        const attachments = photoControl?.getValue();

        const question = sectionedTable
            .getSection('Section123Form')
            .getControl('Section123Question')
            .getValue();
        ...
        await clientAPI.executeAction({
            Name: "/TRL_RH_SnorkelApp/Actions/AttachmentCreate123.action",
            Properties: {
                Properties: {
                    question: question,
