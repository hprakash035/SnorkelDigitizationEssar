 ...
 */
export default async function ValidateAndConvertFileFinalA(clientAPI) {
  ...
  try {
    ...
    const photoSection = sectionedTable.getSection('SectionFinalUserInputImageA');
    ...
    // ✅ Show next section
    // sectionedTable.getSection('SectionFinalBStaticImageInlet').setVisible(true);
